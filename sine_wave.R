...
y <-as.numeric( data[ i,1:12 ]+1)
fit1 <- glm.nb( y ~ x + cos( x/22*2*pi ) + sin( x/22*2*pi ),na.action=na.omit,control=glm.control(maxit=100) )
fit0 <- glm.nb( y ~ x ,control=glm.control(maxit=100) )
